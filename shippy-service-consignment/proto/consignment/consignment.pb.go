...
type Container struct {
	...
	Id          string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	ConstuderId string `protobuf:"bytes,2,opt,name=constuder_id,json=constuderId,proto3" json:"constuder_id,omitempty"`
...
func (x *Container) GetConstuderId() string {
	if x != nil {
		return x.ConstuderId
	}
	return ""
}
...
var file_proto_consignment_consignment_proto_rawDesc = []byte{
	...
	0x64, 0x22, 0x6f, 0x0a, 0x09, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x12, 0x0e,
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x21,
	0x0a, 0x0c, 0x63, 0x6f, 0x6e, 0x73, 0x74, 0x75, 0x64, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x63, 0x6f, 0x6e, 0x73, 0x74, 0x75, 0x64, 0x65, 0x72, 0x49,
